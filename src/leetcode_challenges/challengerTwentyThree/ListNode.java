package leetcode_challenges.challengerTwentyThree;
...
public class ListNode {
    ...
    leetcode_challenges.challengerTwentyOne.ListNode next;
    ...
    ListNode(int val, leetcode_challenges.challengerTwentyOne.ListNode next) {
        this.val = val;
        this.next = next;
    }
}
